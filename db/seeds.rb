...
Event.create!(name: 'Outdoor Improv Show', description: 'Watch hilarious improv sketches under the stars.', category: 'Improv', price: 15, date: Date.today, venue_id: Venue.fourth.id, image: "https://images.unsplash.com/photo-1588928781379-c355ab3edc9b?q=80&w=1740&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")
Event.create!(name: 'Comedy Women', description: 'Take your power back', category: 'Improv', price: 10, date: Date.today + 2, venue_id: Venue.first.id, image: "https://mymolo.de/wp-content/uploads/2023/01/Echolon-Open-Air-300835014_5418191394935191_5265148626473993837_n.jpeg")
Event.create!(name: 'Improvised live', description: 'Come an live with us.', category: 'Improv', price: 10, date: Date.today + 3, venue_id: Venue.second.id, image: "https://image.urlaubspiraten.de/1024/image/upload/v1681228429/Impressions%20and%20Other%20Assets/PawnDotComAtmo1_nedc6j.jpg")
